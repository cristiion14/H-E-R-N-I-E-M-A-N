...
void Render()
{
	...
	{
		XMMATRIX mScale = XMMatrixTranslation(0, 0.01, 0.0);
		m_World1 = mScale*m_World1;
	}
	else if (keyboard.KeyIsPressed('S'))
	{
		XMMATRIX mTranslD = XMMatrixTranslation(0.0f, -0.01f, 0.0f);
		m_World1 = mTranslD *m_World1;
	}
	if (keyboard.KeyIsPressed('A'))
	{
		XMMATRIX mTranslR = XMMatrixTranslation(-0.01, 0.0, 0.00f);
		m_World1 = mTranslR*m_World1;
	}
	else if (keyboard.KeyIsPressed('D'))
	{
		XMMATRIX mTranslL = XMMatrixTranslation(0.01f, 0.00f, 0.00f);
		m_World1 = mTranslL*m_World1;
	}
	else if (keyboard.KeyIsPressed('X'))
	{
		m_World1 = XMMatrixRotationX(t);
	}
	else if (keyboard.KeyIsPressed('Y'))
	{
		m_World1 = XMMatrixRotationY(t);
	}
	else if(keyboard.KeyIsPressed('Z'))
	{
		m_World1 = XMMatrixRotationZ(t);
	}
	else if (keyboard.KeyIsPressed('I'))
	{
		XMMATRIX mTranslD = XMMatrixTranslation(0.0f, 0.0f, 0.01f);
		m_World1 = mTranslD*m_World1;
	}
	else if (keyboard.KeyIsPressed('O'))
	{
		XMMATRIX mTranslD2 = XMMatrixTranslation(0.0f, 0.0f, -0.01f);
		m_World1 = mTranslD2*m_World1;
	}
	...
	XMMATRIX mOrbit1 = XMMatrixRotationY(t * 2.0f);
	XMMATRIX mTranslate1 = XMMatrixTranslation(-4.0f, 0.0f, 0.0f);
	XMMATRIX mScale1 = XMMatrixScaling(0.3f, 0.3f, 0.3f);
	XMMATRIX mbScale1 = XMMatrixScaling(1.0f, 1.0f, 1.0f);
	m_World3 = mScale1 * mSpin1 * mTranslate1 * mOrbit1;
	if (keyboard.KeyIsPressed('G'))
	{
		m_World3 = mbScale1 * mTranslate1 *mOrbit1;
	}
	...
	immediateContext->UpdateSubresource(p_ConstantBuffer, 0, nullptr, &cb3, 0, 0);
	immediateContext->DrawIndexed(36, 0, 0);
